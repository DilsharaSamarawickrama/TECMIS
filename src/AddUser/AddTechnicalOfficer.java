...
public class AddTechnicalOfficer extends javax.swing.JFrame {
    Connection con=null;
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Technical Officer Forum");
        ...
        jPanel2.add(jPanel4);
        jPanel4.setBounds(20, 20, 360, 60);
    ...
    public static void main(String args[]) {  
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddTechnicalOfficer().setVisible(true);
            }
        });
    }
